...
def cadastro(request):    
    if request.method == "GET":
        ...
        if not password_is_valid(request, senha, confirmar_senha) or not email_is_valid(request, email) or not username_is_valid(request, username):
        ...
        try:
            ...
            messages.add_message(request, constants.ERROR, 'Error: Usuario não cadastrado!')
            return redirect('/auth/cadastro')
